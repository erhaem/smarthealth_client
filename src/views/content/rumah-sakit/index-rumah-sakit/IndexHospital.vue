        ...
        <div class="row overflow-auto" style="max-height: 500px">
            ...
            <div class="col-12 col-sm-6 col-md-6 mb-3">
              ...
              <div v-else class="card shadow rounded border-0">
                <div class="card-body" @click="$redirect('detail_rumah_sakit/' + data.idRumahSakit)">
                  ...
                  <template v-else>
                    <img src="../../../../assets/images/fotors.jpg" class="img-fluid rounded mb-2" alt="">
                  </template>
                  <h5 class="card-title mb-0">{{ data.namaRs }}</h5>
                  <p class="text-secondary mb-0">{{ data.deskripsiRs }}</p>
                  <p class="mb-0 text-end"><small>
                    <i class="fas fa-location-dot text-danger"></i> {{ Math.floor(data.distance) }} km
                  </small></p>
                </div>
              </div>
            </div>
          ...
          <template v-for="data in apotekResult" :key="data.id">
            <div class="col-12 col-sm-6 col-md-6 mb-3">
              ...
              <div v-else class="card shadow rounded border-0">
                <div class="card-body"
                  @click="$redirect({ name: 'Detail Apotek', params: { idApotek: data.idProfilApotek, namaApotek: data.namaApotek } })">
                  <template v-if="data.fotoApotek">
                    <img :src="data.fotoApotek" class="img-fluid rounded mb-2" alt="">
                  </template>
                  <template v-else>
                    <img src="../../../../assets/images/drugstore.webp" class="img-fluid rounded mb-2" alt="">
                  </template>
