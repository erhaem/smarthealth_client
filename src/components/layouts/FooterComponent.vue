        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-6 col-md-3">
                    <h6>Quick Links</h6>
                    <ul class="footer-links">
                        <li><a href="http://scanfcode.com/about/">Beranda</a></li>
                        <li><a href="http://scanfcode.com/contact/">Artikel</a></li>
                        <li><a href="http://scanfcode.com/contribute-at-scanfcode/">Aplikasi</a></li>
                        <li><a href="http://scanfcode.com/privacy-policy/">Register</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <ul class="social-icons">
                        ...
                        <li><a class="facebook" href="#"><i class="fa-brands fa-twitter"></i></a></li>
                        <li><a class="facebook" href="#"><i class="fa-brands fa-facebook"></i></a></li>
                        <li><a class="facebook" href="#"><i class="fa-brands fa-linkedin"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
